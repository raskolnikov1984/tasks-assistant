...
export function AllTasksView({ tasks, onEditTask, onBack, onRefresh }: AllTasksViewProps) {
            ...
            return (
              ...
              >
                <div className="all-task-left">
                  <span className="all-task-status" style={{ backgroundColor: statusColors[task.status] }} />
                ...
                <div className="all-task-right">
                  <span className="task-project-badge" style={{ backgroundColor: pColor.bg, color: pColor.text }}>
                    {task.project_name}
                  </span>
                  {task.due_time && <span className="all-task-time">🕐 {task.due_time}</span>}
                  <span className="all-task-date">📅 {formatDate(task.due_date)}</span>
                  <span className="priority-badge" style={{ backgroundColor: prColor.bg, color: prColor.text }}>
                    {task.priority}
                  </span>
                </div>
              </div>
